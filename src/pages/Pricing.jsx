  ...
  return (
    <div className='p-2 mt-[7rem]'>
        ...
        <div className=' p-2 '>
            ...
            <div className='py-6 '>
                <ul className='flex relative items-center justify-center  w-fit mx-auto gap-x-1 sm:gap-x-5 md:gap-x-10 rounded-full cursor-pointer '>
                    <li 
                    onClick={() => {setActiveOne(true), setActiveTwo(false), setActiveThree(false)}}
                    className={`'relative z-[1] text-sm font-semibold p-1 py-3 sm:p-4 md:text-base  ${activeOne && 'text-white'}`}>1 Connection</li>
                    <li 
                    onClick={() => {setActiveOne(false), setActiveTwo(true), setActiveThree(false)}}
                    className={`'relative z-[1] text-sm font-semibold p-1 py-3 sm:p-4 md:text-base  ${activeTwo && 'text-white'}`}>3 Connection</li>
                    <li 
                    onClick={() => {setActiveOne(false), setActiveTwo(false), setActiveThree(true)}}
                    className={`'relative z-[1] text-sm font-semibold p-1 py-3 sm:p-4 md:text-base  ${activeThree && 'text-white'}`}>5 Connection</li>

                    <div className={`absolute top-0 w-[100px] sm:w-[122px] md:w-[140px]  h-full bg-blue rounded-full transition-all duration-200 ease-in-out ${activeOne && "left-0"} ${activeTwo && "left-[6.5rem] sm:left-[9rem] md:left-[11rem]"} ${activeThree && "left-[13rem] sm:left-[18rem] md:left-[22rem]"}`}></div>
                </ul>
            </div>
